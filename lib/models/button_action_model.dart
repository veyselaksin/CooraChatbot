...
List<CustomAppButtonModel> apps=[
  ...
  CustomAppButtonModel(title: "Whatsapp aç", icon: FontAwesomeIcons.whatsapp, url: "whatsapp://send?",color: Color(0xFF128c7e),isApp: true),
  ...
  CustomAppButtonModel(title: "Liste oluştur", icon: FontAwesomeIcons.listUl, color: primaryColor,isApp: false),
];